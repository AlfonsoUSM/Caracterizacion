...
#
# Generated by Vivado on Mon May 11 10:16:59 -0400 2020
...
map_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="G:/Mi unidad/UTFSM/IPD432 - Diseo Avanzado de Sistemas Digitales/git/Caracterizacion/proyecto_pipe/proyecto_pipe.cache/compile_simlib/activehdl"
  fi
