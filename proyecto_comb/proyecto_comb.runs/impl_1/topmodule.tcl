...
set rc [catch {
  ...
  add_files -quiet {{G:/Mi unidad/UTFSM/IPD432 - Diseo Avanzado de Sistemas Digitales/git/Caracterizacion/proyecto_comb/proyecto_comb.runs/synth_1/topmodule.dcp}}
